...
var SignupFormComponent = React.createClass({
    ...
    render: function () {
        return (
            <form ref="_form" onKeyDown={this.handelKeyDown} acceptCharset="UTF-8" role="form" >
                <fieldset>
                    <div className="form-group">
                        <input ref="_firstName" className="form-control" placeholder="First Name" name="firstName" type="text"/>
                    </div>
                    <div className="form-group">
                    ...
                    <div className="form-group">
                        <input ref="_password" className="form-control" placeholder="Password" name="password" type="password"/>
                    </div>
                    <div className="form-group">
